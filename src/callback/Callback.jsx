...
const Callback = () => {
  ...
  const [selectedYes, setSelectedYes] = useState("optionA");
          ...
          <div className="flex flex-wrap gap-4 items-end justify-start align-middle pb-5 w-full ">
            ...
            <div className="w-full sm:w-56">
              <AnimatedDropdown
                ...
                onChange={(value) => setChannelCategory(value)}
                placeholder="Channel"
              />
            </div>
            ...
            <div className="w-full sm:w-56">
              <UniversalButton label="Search" placeholder="Search" />
            </div>
              ...
              {getEnable === "disable" && (
                <div className="flex flex-col gap-3 mt-3">
                  ...
                  <div className="flex flex-row gap-3">
                    ...
                    <div className="flex gap-1">
                      <label className="text-gray-600 font-semibold">XML</label>
                      <RadioButton
                        value="option2"
