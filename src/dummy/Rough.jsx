...
const Header = () => {
  ...
  const iconMap = {
    SMS: <img src={SMSicon} alt="SMS" className="w-6 h-6 mt-1" />,
    '2 Way SMS': <img src={twoWaySMSicon} alt="SMS" className="w-6 h-6 mt-1" />,
    RCS: <img src={RCSicon} alt="SMS" className="w-6 h-6 mt-1" />,
    WhatsApp: <img src={WhatsAppicon} alt="SMS" className="w-6 h-6 mt-1" />,
    Authentication: <img src={Authenticationicon} alt="SMS" className="w-6 h-6 mt-1" />,
    OBD: <img src={OBDicon} alt="SMS" className="w-6 h-6 mt-1" />,
    IBD: <img src={IBDicon} alt="SMS" className="w-6 h-6 mt-1" />,
    'Missed Call': <img src={MissedCallicon} alt="SMS" className="w-6 h-6 mt-1" />,
    Click2Call: <img src={Click2callicon} alt="SMS" className="w-6 h-6 mt-1" />,
    // Blog: <img src={WhatsAppicon} alt="SMS" className="w-6 h-6 mt-1" />,
    Email: <img src={Emailicon} alt="SMS" className="w-6 h-6 mt-1" />,
    // 'Case Studies': <img src={WhatsAppicon} alt="SMS" className="w-6 h-6 mt-1" />
    ECommerce: <img src={Ecommerceicon} alt="SMS" className="w-6 h-6" />,
    Healthcare: <img src={Healthcareicon} alt="SMS" className="w-6 h-6" />,
    Finance: <img src={Financeicon} alt="SMS" className="w-6 h-6" />,
    Education: <img src={Educationicon} alt="SMS" className="w-6 h-6" />,
    Tourism: <img src={Tourismicon} alt="SMS" className="w-6 h-6" />,
    "Real Estate": <img src={RealEstateicon} alt="SMS" className="w-6 h-6" />,
    "Food Production": <img src={FoodProductionicon} alt="SMS" className="w-6 h-6" />,
    "Service-Based": <img src={ServiceBasedicon} alt="SMS" className="w-6 h-6" />,
    "Tech Startups": <img src={TechStartupsicon} alt="SMS" className="w-6 h-6" />,
  };
         ...
         href="#"
          ...
          group-hover:scale-100 transition-all duration-500 ease-out z-50 border border-gray-200 p-2 rounded-md  bg-white">
                ...
                <div className="bg-white text-black popfh border border-gray-200 rounded-md p-2 grid grid-cols-1 gap-2 w-32">
                  <Link href="#" to="https://celitix.com/blog/">
          ...
          <div className="hidden lg:flex flex-shrink-0 gap-3">
            <Link href="#" to="/book-a-demo">
              ...
              hover:shadow-[4px_4px_0px_#9B44B6] comicf'/>
            </Link>
            <a
