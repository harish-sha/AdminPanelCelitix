...
const WhatsappManageWaba = ({ id, name }) => {
    ...
    return (
      ...
      <Dialog
        visible={view}
        onHide={() => setView(false)}
        className="w-[40rem] max-w-full p-0"
        modal
        draggable={false}
      >
        <motion.div
          ...
          <div className="p-8">
            <div className="relative flex justify-center">
              <motion.img
                src={wabadetails?.profile_picture_url || logo}
                alt="Profile"
                className="w-28 h-28 rounded-full border-4 border-white shadow-lg transition-transform transform hover:scale-105"
                initial={{ scale: 0.8 }}
                animate={{ scale: 1 }}
                transition={{ duration: 0.3 }}
              />
              <span className="absolute bottom-2 right-2 bg-green-500 w-6 h-6 rounded-full border-2 border-white"></span>
            </div>

            <div className="mt-6 text-center">
              <p className="text-xl font-semibold text-gray-900 flex items-center justify-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-indigo-500 text-sm hover:underline block mt-1"
              >
                {whatsappLinkPreview}
              </a>
            </div>
            ...
            <motion.div
              className="mt-6 p-5 bg-gradient-to-r from-gray-100 to-gray-200 rounded-xl shadow-inner text-gray-700 text-md leading-relaxed overflow-y-auto"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            {wabadetails?.email && (
              <div className="flex items-center gap-3 mt-6 text-gray-800">
                ...
                <a
                  href={`mailto:${wabadetails.email}`}
                  className="text-indigo-600 text-md hover:underline"
                >
                  {wabadetails.email}
                </a>
              </div>
            ...
            >
                ...
                >
                    ...
                    <div className="bg-[#25D366] p-6 text-white flex flex-col items-center rounded-t-2xl">
                        <motion.img
                            src={wabadetails?.profile_picture_url || logo}
                            alt="Profile"
