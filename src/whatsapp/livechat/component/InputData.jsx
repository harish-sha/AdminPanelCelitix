  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            >
              ...
              />
              <button onClick={handleSearch} className="hover:bg-green-100 rounded-full transition-all cursor-pointer" >
     ...
     hover:bg-[#128c7e] hover:text-[#ece5dd] hover:shadow-md transition-all duration-200 ease-in-out 
                        ...
                        >
                          <DoneAllIcon
                            className={`${chatSwitched === "read" ? "text-green-300" : "text-[#25d366]"} text-xs`}
                            sx={{ fontSize: "18px" }}
                          />
                          Read Count:
                          <span className="font-medium">
                        ...
                        >
                          <DoneAllIcon
                            className={`${chatSwitched === "unread" ? "text-[#075e54]" : "text-gray-500"} text-xs hover:text-white`}
                            sx={{ fontSize: "18px" }}
                          />
                          Unread Count:
                          <span className="font-medium">
