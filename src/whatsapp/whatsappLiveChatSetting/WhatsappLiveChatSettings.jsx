    ...
    >
      ...
      <Box maxWidth="lg" mx="auto" textAlign="center" mb={8}>
        ...
        <Typography variant="subtitle1" color="text.secondary">
          Configure and automate your WhatsApp experience for smoother customer
          communication.
        </Typography>
      </Box>
      ...
      <Grid container spacing={5} justifyContent="center" maxWidth="lg">
        ...
        <Grid item xs={12} sm={6}>
          ...
          Active
            ...
            <Typography variant="body2" color="text.secondary">
              Automatically greet customers when they message you during working
              hours.
            </Typography>
        ...
        <Grid item xs={12} sm={6}>
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary">
              Need help writing your next email? Let us know your goal and we'll
              write it for you.
            </Typography>
            <Box
              sx={{
