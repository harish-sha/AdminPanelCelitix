...
import { getWabaList, sendTemplatetoApi } from "../../../apis/whatsapp/whatsapp.js";
...
const TemplateLibrary = () => {
  ...
  console.log("LibraryTemplates", LibraryTemplates);
  console.log("LibraryFilteredTemplates", LibraryFilteredTemplates);
  ...
  return (
    <>
      <div className="h-[78vh]">
        <div className=" flex flex-wrap md:items-center md:justify-between mb-2">
        ...
        {viewTemplate && (
          ...
          >
            <div className="flex gap-10">
              <div className="bg-white rounded-md shadow-md overflow-hidden w-86">
                ...
                <div className="flex justify-end gap-3 px-4 py-3 bg-gray-50 border-t border-gray-200">
                  <button className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-300 cursor-pointer">
                    Review & Submit
                  </button>
                  <button
                    ...
                    <div className="flex flex-col gap-5 mb-5" >
                      <div className="w-76">
                        <InputField
                          ...
                          label="Template name"
                          type="text"
                          placeholder="Wite template name"
                          value={templateName}
