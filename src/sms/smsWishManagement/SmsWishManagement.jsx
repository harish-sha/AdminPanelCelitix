   ...
   <div className='flex justify-center items-center h-[90vh]'>
     <div className="w-3xl bg-gradient-to-tr from-white via-gray-50 to-white p-8 rounded-3xl shadow-xl border border-gray-200 space-y-8 transition-all duration-300">
      ...
      <div className="flex justify-between items-center border-b pb-4 border-dashed border-gray-300">
        ...
        <CelebrationIcon className="text-yellow-700 animate-bounce" fontSize="medium" /> Wishes Management
        </h2>
        <div className="flex items-center gap-3">
          <span className="text-sm font-medium text-gray-600">Send Wishes:</span>
          <CustomTooltip arrow placement="top" title={status === 1 ? 'Active' : 'Inactive'}>
            <Switch
              checked={status === 1}
      ...
      <div className="flex space-x-4">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-full border transition-all duration-300 ${activeTab === 'birthday'
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-full border transition-all duration-300 ${activeTab === 'anniversary'
