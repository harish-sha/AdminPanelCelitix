...
const DayWiseSummaryTableSms = ({ id, name }) => {
...
const columns = [
  ...
  { field: 'notdelivered', headerName: 'Not delivered', flex: 1, minWidth: 120 },
  { field: 'pendingdr', headerName: 'Pending DR', flex: 1, minWidth: 110 },
  {
    ...
    renderCell: (params) => (
        ...
        <CustomTooltip
                        ...
                        arrow
                    >
            <IconButton className='no-xs' onClick={() => handleDownload(params.row)}>
