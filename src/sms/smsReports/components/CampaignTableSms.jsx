...
const CampaignTableSms = ({ id, name }) => {
...
const columns = [
  ...
  { field: 'totalnumbers', headerName: 'Total Numbers', flex: 1, minWidth: 120 },
  { field: 'totalsmsunits', headerName: 'Total Sms Units', flex: 1, minWidth: 120 },
  ...
  { field: 'ndnc', headerName: 'NDNC', flex: 1, minWidth: 70 },
  {
    ...
    renderCell: (params) => (
        ...
        <CustomTooltip
                        ...
                        arrow
                    >
            <IconButton className='no-xs' onClick={() => handleDetailed(params.row)}>
