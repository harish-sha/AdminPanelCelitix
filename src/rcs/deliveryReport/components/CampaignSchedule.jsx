...
import { fetchCampaignBySrno, scheduledata, cancelschedule } from "@/apis/rcs/rcs.js";
...
const CampaignScheduleTable = ({ id, name, data = [] }) => {
    ...
    const [cancelschdduleData, setCancelScheduleData] = useState([])
    const [campaignScheduleMap, setCampaignScheduleMap] = useState({})
    ...
    // cancelScheduleData
    // useEffect(() => {
    //     const fetchCancelScheduleData = async () => {
    //         try {
    //             const res = await cancelschedule;
    //             setCancelScheduleData(res)
    //         } catch (err) {
    //             toast.error("Error Schedule Cancelation", err)
    //         }
    //     }
    //     fetchCancelScheduleData()
    // }, [])
    ...
    const handleCancel = async (row) => {
        ...
        try {
            const res = await cancelschedule({ campaignSrno: campaignId });
